...
// Define the build directory and output file path in the root directory
...
// Write the result to index.js, overwriting any existing file
fs.writeFileSync(outputPath, result);

console.log('Build complete: index.js created in build directory.');
